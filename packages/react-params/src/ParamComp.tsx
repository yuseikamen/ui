...
export default function ParamComp ({ defaultValue, index, isDisabled, name, onChange, onEnter, onEscape, overrides, type, assetIdContext }: Props): React.ReactElement<Props> {
